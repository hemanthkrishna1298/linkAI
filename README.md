...
You need a LinkedIn developer app so Claude can post on your behalf. Claude walks you through this the first time you ask for a post — or see [`plugins/linkai/skills/linkedin-posting/SETUP.md`](plugins/linkai/skills/linkedin-posting/SETUP.md) for the manual steps. The short version:
